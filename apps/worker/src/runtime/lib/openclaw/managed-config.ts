...
> = {
  "AGENTS.md": {
    ...
    systemContent: [
      ...
      "",
      "Each project's canonical project entry point lives at `projects/<project-key>/<project-key>.md`. Repeat the project key in the filename so grep/find can discover project briefs directly.",
      "",
      ...
      "",
      "If the user introduces a new business idea that does not match an existing project, create a new project folder, create `projects/<project-key>/<project-key>.md`, and add it to `projects/_index.md`.",
      "",
      ...
      "",
      "- `<project-key>.md`: canonical project entry point and diarized project profile. Read this first.",
      ...
      "",
      "For a new project, start with `projects/<project-key>/<project-key>.md` and `onboarding.md`.",
      "",
      ...
      "",
      "After onboarding, store the result in `projects/<project-key>/<project-key>.md`.",
      "",
