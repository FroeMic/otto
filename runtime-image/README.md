...
OpenClaw `2026.4.15` resolves bundled plugins from `/app/dist/extensions` in the
...
docker build \
  ...
  -t ghcr.io/froemic/otto-openclaw:2026.4.15.1 .
```
...
```bash
RUNTIME_OPENCLAW_IMAGE=ghcr.io/froemic/otto-openclaw:2026.4.15.1
```
