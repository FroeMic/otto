import { PlatformActivityContent } from "../_components/platform-activity-content";
import { buildPlatformActivityData } from "../_lib/platform-activity-data";
import {
...
export default async function PlatformOrganizationJobsPage({
  params,
}: {
