...
- The first real frontend shell now exists:
  ...
  - the primary workspace sidebar no longer advertises `Overview` and no longer renders the old `Otto` section header; `Sessions` now appears above `Skills` as the first primary workspace item
