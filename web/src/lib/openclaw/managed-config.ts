...
> = {
  "AGENTS.md": {
    ...
    systemContent: [
      ...
      "When Otto needs to change AGENTS.md, IDENTITY.md, or TOOLS.md, it must use the dedicated managed-config tools instead of direct local file writes.",
  ...
  "TOOLS.md": {
    ...
    systemContent: [
      "Use managed-config tools for AGENTS.md, IDENTITY.md, and TOOLS.md.",
