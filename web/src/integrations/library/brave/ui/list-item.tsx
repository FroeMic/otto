...
import type { IntegrationOverviewItemProps } from "@/integrations/framework";

export function BraveIntegrationListItem({
  entry,
      ...
      <div className="flex min-w-0 items-start gap-4">
        ...
        <div className="flex min-w-0 flex-col gap-1">
          <div className="flex items-center gap-2">
            ...
            {entry.connected ? <Badge variant="outline">Managed</Badge> : null}
