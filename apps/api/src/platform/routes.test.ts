...
function createDependencies(): PlatformRouteDependencies {
  return {
    ...
    getPlatformOrganizationDetail: async () => ({
      ...
      configuredRuntimeImage: "ghcr.io/froemic/openclaw:2026.4.22",
      configuredRuntimeImageVersion: "2026.4.22",
      id: "org_1",
      isReady: true,
      locale: "en-US",
      name: "Interaction42",
      observedRuntimeImage: "ghcr.io/froemic/openclaw:2026.4.22",
      observedRuntimeImageVersion: "2026.4.22",
